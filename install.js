...
const basePath = `https://github.com/pseudomuto/${BIN_NAME}/releases/download`;

const tarPath = `v${VERSION}/${BIN_NAME}-${VERSION}.${platform}-${arch}.go${GO_VERSION}.tar.gz`;
